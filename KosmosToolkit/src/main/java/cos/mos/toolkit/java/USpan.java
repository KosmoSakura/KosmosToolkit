...
public final class USpan {
    ...
    private static final String LINE_SEPARATOR = System.getProperty("line.separator");//获取操作系统对应的换行符
    ...
    /**
     * @param color       页边距颜色
     * @param stripeWidth 页边距宽度，以像素为单位。
    ...
    /**
     * @param color    bullet颜色
     * @param radius   bullet半径，以像素为单位。
     * @param gapWidth 间隙宽度，以像素为单位。
     * @Tip bullet相关
     */
...
//            }
    ...
    /**
     * 页边距的段落风格。一个段落可以有多个前边距;
     * 它们将按顺序呈现，每个*将其边距添加到前面的边距中。
     * 在从右到左的段落中，最前面的空白在右边。
     * 每个段落的第一个字符到最后一个字符之间应该有一个空格。
     */
