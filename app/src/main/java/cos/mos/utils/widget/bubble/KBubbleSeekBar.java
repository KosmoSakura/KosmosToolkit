...
public class KBubbleSeekBar extends View {
    ...
    public KBubbleSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTrackSize = ta.getDimensionPixelSize(R.styleable.KBubbleSeekBar_bsb_track_size, KBubbleUtils.dp2px(2));
        mSecondTrackSize = ta.getDimensionPixelSize(R.styleable.KBubbleSeekBar_bsb_second_track_size,
            mTrackSize + KBubbleUtils.dp2px(2));
        mThumbRadius = ta.getDimensionPixelSize(R.styleable.KBubbleSeekBar_bsb_thumb_radius, mSecondTrackSize / 2 + KBubbleUtils.dp2px(1));
        mThumbRadiusOnDragging = ta.getDimensionPixelSize(R.styleable.KBubbleSeekBar_bsb_thumb_radius_on_dragging,
            mThumbRadius + KBubbleUtils.dp2px(2));
        ...
        mSectionTextSize = ta.getDimensionPixelSize(R.styleable.KBubbleSeekBar_bsb_section_text_size, KBubbleUtils.sp2px(14));
        ...
        mThumbTextSize = ta.getDimensionPixelSize(R.styleable.KBubbleSeekBar_bsb_thumb_text_size, KBubbleUtils.sp2px(14));
        ...
        mBubbleTextSize = ta.getDimensionPixelSize(R.styleable.KBubbleSeekBar_bsb_bubble_text_size, KBubbleUtils.sp2px(14));
        ...
        mRectText = new Rect();
        mTextSpace = KBubbleUtils.dp2px(2);
    ...
    private void initConfigByPriority() {
        ...
        if (mSecondTrackSize < mTrackSize) {
            mSecondTrackSize = mTrackSize + KBubbleUtils.dp2px(2);
        }
        if (mSectionCount <= 0) {
            mSectionCount = 10;
        }
    ...
    private void calculateRadiusOfBubble() {
        ...
        mBubbleRadius = KBubbleUtils.dp2px(14); // default 14dp
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        height += mTextSpace * 2;
        setMeasuredDimension(resolveSize(KBubbleUtils.dp2px(180), widthMeasureSpec), height);
    ...
    private void locatePositionOnScreen() {
        ...
        mBubbleCenterRawSolidY -= KBubbleUtils.dp2px(24);
//        if (KBubbleUtils.isMIUI()) {
//            mBubbleCenterRawSolidY += KBubbleUtils.dp2px(4);
//        }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isShowTextBelowSectionMark || isShowSectionMark) {
            ...
            float r = (mThumbRadiusOnDragging - KBubbleUtils.dp2px(2)) / 2f;
    ...
    private boolean isThumbTouched(MotionEvent event) {
        ...
        return (event.getX() - x) * (event.getX() - x) + (event.getY() - y) * (event.getY() - y)
            <= (mLeft + KBubbleUtils.dp2px(8)) * (mLeft + KBubbleUtils.dp2px(8));
    }
    ...
    private class BubbleView extends View {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            mBubblePath.quadTo(
                x1 - KBubbleUtils.dp2px(2), y1 - KBubbleUtils.dp2px(2),
                x1, y1
            );
            ...
            mBubblePath.quadTo(
                x2 + KBubbleUtils.dp2px(2), y1 - KBubbleUtils.dp2px(2),
                x0, y0
            );
            mBubblePath.close();
