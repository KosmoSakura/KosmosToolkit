 ...
 * @Author: guanaj
 * @Date: 2017年6月5日
 * @link https://github.com/anzaizai/EasySwipeMenuLayout
 */
...
//                    break;
//                }
                // LogInterceptor.i(TAG, ">>>>>distanceX:" + distanceX);
...
//                        || Math.abs(getScrollX()) > mScaledTouchSlop
                    ...
                    //  LogInterceptor.i(TAG, ">>>>当处于水平滑动时，禁止父类拦截 true");
                    getParent().requestDisallowInterceptTouchEvent(true);
                }
                mLastP.set(ev.getRawX(), ev.getRawY());
    ...
    public boolean onInterceptTouchEvent(MotionEvent event) {
        //  LogInterceptor.d(TAG, "<<<<dispatchTouchEvent() called with: " + "ev = [" + event + "]");
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                if (Math.abs(finalyDistanceX) > mScaledTouchSlop) {
                    ...
                    //   LogInterceptor.i(TAG, "<<<onInterceptTouchEvent true");
                    return true;
                }
//                if (Math.abs(finalyDistanceX) > mScaledTouchSlop || Math.abs(getScrollX()) > mScaledTouchSlop) {
//                    LogInterceptor.d(TAG, "onInterceptTouchEvent: 2");
//                    return true;
//                }
                break;
    ...
    protected void onDetachedFromWindow() {
        ...
        //  LogInterceptor.i(TAG, ">>>>>>>>onDetachedFromWindow");
    ...
    protected void onAttachedToWindow() {
        ...
        // LogInterceptor.i(TAG, ">>>>>>>>onAttachedToWindow");
    }
