...
import cos.mos.toolkit.media.image.glide.transform.TransformBlur;
import cos.mos.toolkit.media.image.glide.transform.TransformCircle;
import cos.mos.toolkit.media.image.glide.transform.TransformRound;
...
public class UGlideEffect {
    ...
    public static void loadBlurPic(Context context, String string, ImageView tartgetIv) {
        GlideApp.with(context)
            .load(string)
            .placeholder(R.color.fun_bg_white)
            .error(R.color.fun_bg_white)
